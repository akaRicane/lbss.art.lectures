/**
 * postprocessing v6.35.5 build Thu Jun 13 2024
...
import { LinearFilter, SRGBColorSpace, UnsignedByteType, WebGLRenderTarget as WebGLRenderTarget2 } from "../src/Three.js";

// src/materials/CopyMaterial.js
import { NoBlending, ShaderMaterial, Uniform } from "../src/Three.js";

// src/utils/BackCompat.js
import { REVISION } from "../src/Three.js";
...
import { LinearSRGBColorSpace } from "../src/Three.js";
...
import { BackSide, DoubleSide, FrontSide, ShaderMaterial as ShaderMaterial2 } from "../src/Three.js";
...
import { EventDispatcher, Vector2 as Vector22 } from "../src/Three.js";
var AUTO_SIZE = -1;
...
import { EventDispatcher as EventDispatcher2, Uniform as Uniform2 } from "../src/Three.js";
...
import { SRGBColorSpace as SRGBColorSpace5, Uniform as Uniform7, WebGLRenderTarget as WebGLRenderTarget8 } from "../src/Three.js";
...
import { SRGBColorSpace as SRGBColorSpace3, UnsignedByteType as UnsignedByteType3, WebGLRenderTarget as WebGLRenderTarget4 } from "../src/Three.js";

// src/materials/KawaseBlurMaterial.js
import { NoBlending as NoBlending2, ShaderMaterial as ShaderMaterial3, Uniform as Uniform3, Vector4 } from "../src/Three.js";
...
import { UnsignedByteType as UnsignedByteType4, WebGLRenderTarget as WebGLRenderTarget5 } from "../src/Three.js";

// src/materials/LuminanceMaterial.js
import { NoBlending as NoBlending3, REVISION as REVISION2, ShaderMaterial as ShaderMaterial4, Uniform as Uniform4 } from "../src/Three.js";
...
import { SRGBColorSpace as SRGBColorSpace4, UnsignedByteType as UnsignedByteType5, Vector2 as Vector25, WebGLRenderTarget as WebGLRenderTarget6 } from "../src/Three.js";

// src/materials/DownsamplingMaterial.js
import { NoBlending as NoBlending4, ShaderMaterial as ShaderMaterial5, Uniform as Uniform5, Vector2 as Vector23 } from "../src/Three.js";
...
import { NoBlending as NoBlending5, ShaderMaterial as ShaderMaterial6, Uniform as Uniform6, Vector2 as Vector24 } from "../src/Three.js";
...
import { Uniform as Uniform8 } from "../src/Three.js";
...
import { SRGBColorSpace as SRGBColorSpace6, Uniform as Uniform9 } from "../src/Three.js";
...
import { Uniform as Uniform10 } from "../src/Three.js";
...
import { Uniform as Uniform11, Vector2 as Vector26 } from "../src/Three.js";
...
import { BasicDepthPacking as BasicDepthPacking4, SRGBColorSpace as SRGBColorSpace7, Uniform as Uniform15, UnsignedByteType as UnsignedByteType8, WebGLRenderTarget as WebGLRenderTarget9 } from "../src/Three.js";
...
import { NoBlending as NoBlending6, ShaderMaterial as ShaderMaterial7, Uniform as Uniform12, Vector2 as Vector27 } from "../src/Three.js";
...
import { BasicDepthPacking as BasicDepthPacking3, NoBlending as NoBlending7, PerspectiveCamera, ShaderMaterial as ShaderMaterial8, Uniform as Uniform13 } from "../src/Three.js";
...
import { NoBlending as NoBlending8, ShaderMaterial as ShaderMaterial9, Uniform as Uniform14, UnsignedByteType as UnsignedByteType6 } from "../src/Three.js";
...
import { UnsignedByteType as UnsignedByteType7 } from "../src/Three.js";
...
import { Uniform as Uniform16, Vector2 as Vector28 } from "../src/Three.js";
...
import { Uniform as Uniform17 } from "../src/Three.js";
...
import { NearestFilter, RepeatWrapping, RGBAFormat as RGBAFormat2, Uniform as Uniform18, Vector2 as Vector29 } from "../src/Three.js";
...
import { NoBlending as NoBlending10, ShaderMaterial as ShaderMaterial11, Uniform as Uniform20 } from "../src/Three.js";
...
import { Uniform as Uniform22, Vector2 as Vector212 } from "../src/Three.js";
...
import { Uniform as Uniform23, Vector3 as Vector32 } from "../src/Three.js";
...
import { Uniform as Uniform24, Vector2 as Vector213 } from "../src/Three.js";
...
import { FloatType, HalfFloatType, Uniform as Uniform25 } from "../src/Three.js";
...
import { Color as Color5, RepeatWrapping as RepeatWrapping2, Uniform as Uniform29, UnsignedByteType as UnsignedByteType11, WebGLRenderTarget as WebGLRenderTarget12 } from "../src/Three.js";

// src/materials/DepthComparisonMaterial.js
import { NoBlending as NoBlending11, PerspectiveCamera as PerspectiveCamera3, RGBADepthPacking, ShaderMaterial as ShaderMaterial12, Uniform as Uniform27 } from "../src/Three.js";
...
import { NoBlending as NoBlending12, ShaderMaterial as ShaderMaterial13, Uniform as Uniform28, Vector2 as Vector214 } from "../src/Three.js";
...
import { Color as Color4, MeshDepthMaterial, NearestFilter as NearestFilter3, RGBADepthPacking as RGBADepthPacking2, WebGLRenderTarget as WebGLRenderTarget11 } from "../src/Three.js";
...
import { Uniform as Uniform30, Vector2 as Vector215, Vector4 as Vector42 } from "../src/Three.js";
...
import { Uniform as Uniform31, Vector4 as Vector43 } from "../src/Three.js";
...
import { Uniform as Uniform32, Vector2 as Vector216 } from "../src/Three.js";
...
import { Uniform as Uniform33, Vector2 as Vector217, Vector3 as Vector35 } from "../src/Three.js";
...
import { Uniform as Uniform34, Vector3 as Vector36 } from "../src/Three.js";
...
import { BasicDepthPacking as BasicDepthPacking8, NoBlending as NoBlending13, REVISION as REVISION3, ShaderMaterial as ShaderMaterial14, Uniform as Uniform35, Vector2 as Vector218 } from "../src/Three.js";
...
import { NoBlending as NoBlending14, ShaderMaterial as ShaderMaterial15, Uniform as Uniform36, Vector2 as Vector219 } from "../src/Three.js";
...
import { BasicDepthPacking as BasicDepthPacking13, Color as Color8, RepeatWrapping as RepeatWrapping3, RGBAFormat as RGBAFormat4, Uniform as Uniform40, WebGLRenderTarget as WebGLRenderTarget16 } from "../src/Three.js";

// src/materials/SSAOMaterial.js
import { BasicDepthPacking as BasicDepthPacking10, Matrix4 as Matrix42, NoBlending as NoBlending15, PerspectiveCamera as PerspectiveCamera4, ShaderMaterial as ShaderMaterial16, Uniform as Uniform38, Vector2 as Vector220 } from "../src/Three.js";
...
import { BasicDepthPacking as BasicDepthPacking12, FloatType as FloatType4, NearestFilter as NearestFilter5, WebGLRenderTarget as WebGLRenderTarget15 } from "../src/Three.js";

// src/materials/DepthDownsamplingMaterial.js
import { BasicDepthPacking as BasicDepthPacking11, NoBlending as NoBlending16, ShaderMaterial as ShaderMaterial17, Uniform as Uniform39, Vector2 as Vector221 } from "../src/Three.js";
...
import { Uniform as Uniform41, UnsignedByteType as UnsignedByteType12 } from "../src/Three.js";
...
import { SRGBColorSpace as SRGBColorSpace12, Uniform as Uniform43, Vector2 as Vector223, WebGLRenderTarget as WebGLRenderTarget17 } from "../src/Three.js";

// src/materials/TiltShiftBlurMaterial.js
import { Uniform as Uniform42, Vector2 as Vector222, Vector4 as Vector44 } from "../src/Three.js";
...
import { LinearMipmapLinearFilter, Uniform as Uniform45, WebGLRenderTarget as WebGLRenderTarget19 } from "../src/Three.js";

// src/passes/AdaptiveLuminancePass.js
import { NearestFilter as NearestFilter6, WebGLRenderTarget as WebGLRenderTarget18 } from "../src/Three.js";

// src/materials/AdaptiveLuminanceMaterial.js
import { NoBlending as NoBlending17, ShaderMaterial as ShaderMaterial18, Uniform as Uniform44 } from "../src/Three.js";
...
import { Uniform as Uniform46 } from "../src/Three.js";
...
import { FileLoader, Loader, LoadingManager as LoadingManager2 } from "../src/Three.js";
...
import { FileLoader as FileLoader2, Loader as Loader2, LoadingManager as LoadingManager3, Vector3 as Vector37 } from "../src/Three.js";
...
import { Loader as Loader3, LoadingManager as LoadingManager4 } from "../src/Three.js";
...
import { NoBlending as NoBlending18, PerspectiveCamera as PerspectiveCamera5, ShaderMaterial as ShaderMaterial19, Uniform as Uniform47, Vector2 as Vector224 } from "../src/Three.js";
...
import { BasicDepthPacking as BasicDepthPacking14, NoBlending as NoBlending19, ShaderMaterial as ShaderMaterial20, Uniform as Uniform48, Vector2 as Vector225 } from "../src/Three.js";
...
import { BasicDepthPacking as BasicDepthPacking15, NoBlending as NoBlending20, PerspectiveCamera as PerspectiveCamera6, REVISION as REVISION4, ShaderMaterial as ShaderMaterial21, Uniform as Uniform49, Vector2 as Vector226 } from "../src/Three.js";
...
import { NoBlending as NoBlending21, ShaderMaterial as ShaderMaterial22, Uniform as Uniform50, Vector2 as Vector227 } from "../src/Three.js";
...
import { BasicDepthPacking as BasicDepthPacking16, SRGBColorSpace as SRGBColorSpace13, UnsignedByteType as UnsignedByteType13, WebGLRenderTarget as WebGLRenderTarget20 } from "../src/Three.js";
...
import { FloatType as FloatType6, RGBADepthPacking as RGBADepthPacking5 } from "../src/Three.js";
...
import { BasicDepthPacking as BasicDepthPacking18, NoColorSpace as NoColorSpace2, SRGBColorSpace as SRGBColorSpace14, UnsignedByteType as UnsignedByteType15 } from "../src/Three.js";
...
`;
    ...
    if (mainImageExists) {
      if (effect.inputColorSpace !== null && effect.inputColorSpace !== data.colorSpace) {
        fragmentMainImage += effect.inputColorSpace === SRGBColorSpace14 ? "color0 = LinearTosRGB(color0);\n	" : "color0 = sRGBToLinear(color0);\n	";
      }
...
import { SRGBColorSpace as SRGBColorSpace15, UnsignedByteType as UnsignedByteType16, WebGLRenderTarget as WebGLRenderTarget22 } from "../src/Three.js";
...
import { Color as Color9, MeshNormalMaterial, NearestFilter as NearestFilter8, WebGLRenderTarget as WebGLRenderTarget23 } from "../src/Three.js";
...
import { LoadingManager as LoadingManager5 } from "../src/Three.js";
